const UI = {
    ...
    get achievementModal() { return document.getElementById('achievement-modal'); },
    get achievementContainer() { return document.getElementById('achievement-container'); },
    get achievementProgress() { return document.getElementById('achievement-progress'); },
    get achievementTabs() { return document.querySelectorAll('.achieve-tab-btn'); },
    ...
    toggleAchievementModal(show) {
        ...
        if (show) {
            if (!this.achievementTabs[0].dataset.initialized) {
            ...
            this.achievementTabs.forEach(t => t.classList.remove('active'));
            document.querySelector('.achieve-tab-btn[data-filter="all"]').classList.add('active');
        } else {
